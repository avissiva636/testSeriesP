...
const ScheduledTest = () => {
  const { scheduled, scheduledQuestions } = useInspiroCrud();
  const questionDetails = scheduled?.question;
  return (
    <Stack>
        ...
        >
          {questionDetails.map((data) => (
            <Card
              ...
              sx={{
                width: "500px",
                minHeight: questionDetails.length < 4 ? "300px" : "auto",
                height: questionDetails.length < 4 ? "200px" : "auto",
                textAlign: "center",
                margin: "10px",
                    ...
                    <Grid item>
                      <Button variant="contained" color="success">
                        <Link
                          ...
                          state={{
                            data: data,
                            archiveQuestions: scheduledQuestions, //reusing archive logic here.Naming may confuse
                          }}
