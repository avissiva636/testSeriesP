export const purchasedTest = {
  ...
  mains: [
    {
      title: "Mains KAS Unit Wise Test Series",
      description: "Highly recommended test series for your exam preparation",
      details:
        "http://exam.inspiroias.in/administrator/uploads/All_Karnataka_KAS_2024_Prelims_Test_Series_Schedule_batch_53.jpg",
      testCount: 15,
...
export const prelimsTest = {
  paid: [
    {
      title: "Paid KAS Prelims Unit Wise Test Series",
      description: "Highly recommended test series for your exam preparation",
      details:
        "http://exam.inspiroias.in/administrator/uploads/All_Karnataka_KAS_2024_Prelims_Test_Series_Schedule_batch_53.jpg",
      testCount: 15,
...
export const mainsQuestions = {
  questions: [{ question: "Define some Question" }],
};
