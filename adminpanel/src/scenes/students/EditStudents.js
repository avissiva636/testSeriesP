...
const EditStudents = () => {
    ...
    const [name, setName] = useState(decodeURIComponent(urlName));
    const [age, setAge] = useState();
    const [sex, setSex] = useState('Male');
    const [userName, setUserName] = useState(decodeURIComponent(urlUsername));
    const [password, setPassword] = useState();
    const [course, setCourse] = useState();
    const [batch, setBatch] = useState();
    const [email, setEmail] = useState(decodeURIComponent(urlEmailid));
    const [mobile, setMobile] = useState(decodeURIComponent(urlMobileno));
    const [telephone, setTelephone] = useState();
    const [status, setStatus] = useState(decodeURIComponent(urlStatus));
