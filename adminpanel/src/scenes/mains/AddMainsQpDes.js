...
import { useGetBatchesQuery, useGetCoursesQuery, useGetOutlinesQuery, useGetSubjectsQuery } from 'state/apiDevelopmentSlice';
...
const AddMainsQpDes = () => {
    ...
    const [qpSeries, setQpSeries] = useState('');
    ...
    // const [createStudent] = useCreatem;
